Template project (Django Project)

Student: Nadezhda Mihaylova (username: nadmih)
...
- Class-based views - SignUpView, ArticleCreatView, UpdateArticleView, ArticlesListView;

- Additional functionality - at the discretion of the examiner;
